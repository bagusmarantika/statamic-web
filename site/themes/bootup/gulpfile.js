...
gulp.task('bowerscripts', function(done) {
  return gulp.src([
...
gulp.task('init', gulp.series('csscopy','bowerscripts','css', 'js', function(done) {
    done();
}));
...
gulp.task('default', gulp.series('bowerscripts','css', 'js', function () {
